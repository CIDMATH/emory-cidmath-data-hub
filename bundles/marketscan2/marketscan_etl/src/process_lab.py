"""
Process LAB files to Delta tables.

Pattern: /Volumes/.../LAB/2014 v30/Set A/PARQUET/ccaea143_a_0_0_0.snappy.parquet
...
def derive_table_name(file_path: str) -> str:
    """
    Extract table name from LAB file path.
    
    Example:
        /LAB/2014 v30/Set A/PARQUET/ccaea143_a_0_0_0.snappy.parquet
